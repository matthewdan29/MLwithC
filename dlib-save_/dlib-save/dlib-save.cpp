...
void TrainAndSaveKRR(const std::vetor<matrix<double>>& x, const std::vector<float>& y)
{
...
void TrainAndSaveNetwork(const std::vector<matrix<double>>& x, const std::vector<float>& y)
{
	...
	seriablize("dlib-net.dat") << network; 
...
int main()
{
	...
	/*let the normlizer learn the mean and standard deviation of the samples*/
