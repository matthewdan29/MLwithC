...
#include <shogun/until/factory.h>
#include <iostream>
#include <random>
...
int main(int, char*[])
{
	...
	/*we can get calculated parameter vector*/
	...
	/*Also we can calculate value of Mean Square Error:*/
