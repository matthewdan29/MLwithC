...
class NMISTDataset : public torch::data::Dataset<MNISTDataset>
{
	public: 
		MNISTDataset(const std::string& images_file_name, const std::string& label_file_name, torch::DeviceType device); 

		/*test only method*/
		void ShowItem(size_t index) const; 

		/*torch::data::Dataset implementaion*/
