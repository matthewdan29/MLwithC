...
public class MainActivity extends AppXompatActivity
{
	...
	/* A native methods that are implemented by the 'native-lib' native library, which is packaged with this application */
	...
	{
		if (requestedCode == Image_Capture_Code)
		{
			if (resultCode == RESULT_OK)
			{
				...
				if (bp != null)
				{
					...
					if (argb_bp != null)
					{
						...
						TextView class_view = fivdViewById(R.id.textViewClass); 
